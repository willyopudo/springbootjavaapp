...
import static com.springjpa.KeyProperty.DATABASE_ENCRYPTION_KEY;
...
abstract class AbstractCryptoConverter<T> implements AttributeConverter<T, String> {
    ...
    public String convertToDatabaseColumn(T attribute) {
        if (isNotNullOrEmpty((String) DATABASE_ENCRYPTION_KEY) && isNotNullOrEmpty((String) attribute)) {
            try {
    ...
    public T convertToEntityAttribute(String dbData) {
        if (isNotNullOrEmpty((String)DATABASE_ENCRYPTION_KEY) && isNotNullOrEmpty(dbData)) {
            try {
    ...
    abstract boolean isNotNullOrEmpty(String dATABASE_ENCRYPTION_KEY);
